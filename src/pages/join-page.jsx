          ...
          <div className="joinForm">
            ...
            <section>
              ...
              <div className="termsBox">
                <div className="joinTextBox">
                  ...
                  <ul>
                    <li>
                      (1)이용 계약은 이용자의 이용 신청에 대한 병원의 이용
                      응낙과 이용자의 약관 내용에 대한 동의로 성립됩니다.
                    </li>
                    ...
                    <li>
                      (4)병원은 다음 각 호에 해당하는 이용계약신청에 대하여는
                      이를 응낙하지 않습니다.
                      <p>① 다른 사람의 명의를 사용하여 신청하였을 때</p>
                      <p>
                        ② 이용 계약 신청서의 내용을 허위로 기재하였거나
                        허위서류를 첨부하여 신청하였을 때
                      </p>
                      <p>
                  ...
                  <ul>
                    ...
                    <li>
                      (3)회원에 가입한 후라도 일부 서비스 이용 시 이용자의
                      연령에 따른 서비스 이용을 제한할 수 있습니다.
                    </li>
                  </ul>
                  ...
                  <ul>
                    <li>
                      (1)병원이 특별한 사정이 없는 한 이용자가 신청한 서비스
                      제공 개시일에 서비스를 이용 할 수 있도록 합니다.
                    </li>
                  ...
                  <p>
                    ...
                    행위를 하였을 경우 사전 통지 없이 이용 계약을 해지 하거나
                  ...
                  <ul>
                    <li>
                      ...
                      경우에는 그 사유, 일시 및 기간을 정하여 서면 또는 전화
                      등의 방법에 의하여 해당 이용자 또는 대리인에게 통지합니다.
                      다만, 병원가 긴급하게 이용을 정지할 필요가 있다고 인정하는
                      경우에는 그러하지 아니합니다.
                    </li>

                    <li>
                      (2)제1항의 규정에 의하여 이용정지의 통지를 받은 이용자
                      또는 그 대리인은 그 이용정지의 통지에 대하여 이의가 있을
                      때에는 이의신청을 할 수 있습니다.
                    </li>
                    ...
                    <li>
                      (4)병원은 이용정지 기간 중에 그 이용정지 사유가 해소된
                      것이 확인된 경우에는 이용 정지 조치를 즉시 해제합니다.
                    </li>
                  </ul>

                  <h5>제3조 이용자의 게시물</h5>
                  <p>
                    병원은 이용자가 게시하거나 등록하는 서비스 내의 내용물이
                    다음 각 사항에 해당된다고 판단되는 경우에 사전 통지 없이
                    삭제할 수 있습니다.
                  </p>

                  <ul>
                    <li>
                      (1)다른 이용자 또는 제 3자를 비방하거나 중상 모략으로
                      명예를 손상시키는 내용인 경우
                    </li>
            ...
            <section>
              ...
              <div className="privacyBox">
                <div className="joinTextBox">
                  <p>
                    모두한의원은 (이하 '병원') 환자 여러분들의 개인 정보를
                    소중히 생각하며 [정보통신망 이용촉진 및 정보보호]에 관한
                    법률을 준수하고 있습니다. 이에 본원은 개인정보처리방침에
                    따라 환자 여러분이 제공하는 개인 정보가 어떠한 용도와
                    방식으로 이용되고 있으며, 이를 위해 어떠한 조치가 취해지고
                    있는지 알려드립니다. 개인정보처리 방침의 순서는 다음과
                    같습니다.
                  </p>
                  ...
                  <ul>
                    ...
                    <li>❑동의철회 / 회원탈퇴 방법</li>
                    <li>
                      ❑개인정보 자동 수집 장치의 설치/운영 및 그 거부에 관한
                      사항
                    </li>
                    <li>❑개인정보관리책임자</li>
                    ...
                    <li>
                      ...
                      수집합니다. 병원의 서비스를 이용하기 위해서는 회원가입 시
                      필수항목과 선택항목이 있는데, 메일수신여부 등과 같은
                      선택항목은 입력하지 않더라도 서비스 이용에는 제한이
                      없습니다.
                    </li>
                  </ul>
                  ...
                  <p>
                    ...
                    의하여 보존할 필요성이 있는 경우에는 귀하의 개인정보를
                    보유할 수 있습니다.
                  </p>
                  ...
                  <ul>
                    ...
                    <li>
                      ❑ 개인정보의 파기절차 및 그 방법 병원은 [개인정보의 수집
                      및 이용목적]이 달성된 후에는 즉시 파기합니다. 파기절차 및
                  ...
                  <ul>
                    <li>
                      ❑ 개인정보 제공 및 공유
                      <p>
                        병원은 귀하의 동의가 있거나 관련법령의 규정에 의한
                        경우를 제외하고는 어떠한 경우에도 [개인정보의 수집 및
                    ...
                    <li>
                      - 통계작성ㆍ학술연구를 위하여 필요한 경우 특정 개인을
                      알아볼 수 없는 형태로 가공하여 제공
                    </li>
                    ...
                    <li>
                      ...
                      <p>
                        ...
                        위하여 아동으로부터 법정대리인의 성명과 연락처 등
                        최소한의 정보를 수집하고 있으며, 개인정보취급방침에서
                        규정하고 있는 방법에 따라 법정대리인의 동의를 받고
                        있습니다. 아동의 법정대리인은 아동의 개인정보에 대한
                        열람, 정정 및 삭제를 요청할 수 있습니다. 아동의
                        개인정보를 열람•정정, 삭제하고자 할 경우에는
                        회원정보수정을 클릭하여 법정대리인 확인 절차를 거치신 후
                        아동의 개인정보를 법정대리인이 직접 열람•정정,
                        삭제하거나, 개인정보보호책임자로 서면, 전화, 또는
                        Fax등으로 연락하시면 필요한 조치를 취합니다. 병원은
                        아동에 관한 정보를 제3자에게 제공하거나 공유하지 않으며,
                        아동으로부터 수집한 개인정보에 대하여 법정대리인이
                        오류의 정정을 요구하는 경우 그 오류를 정정할 때까지 해당
